...
import be.patryksitko.contest.ip2location.com.component.Ip2LocationDB.Download.DownloadedDataExceptionTriggers;
...
public class Ip2LocationDB {
    ...
    public static enum Download {
        ...
        private static final String authenticationToken = "The token from the ip2location.lite website. If you don't work with annotations.";
        private URL downloadURL;

        private Download(URL local) {
            // for dev-purposes only, as the file can be downloaded only 5 times an hour.
            // uncomment next line and comment up the uncommented code inside of this scope.
